...
%FLAG - FOR DEBUGGING PURPOSES, i'M GOING TO JUST FIX THIS TO A VALUE. tHIS
%SHOULD BE MADE INTO A COMMAND LINE ARGUMENT LATER
%is this a reasonable SNR? um. I should check this
...
output_filename = filename + ["impair", SNR,"dB.wav"];
